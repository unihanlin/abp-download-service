...
namespace Unihanlin.AbpDownloadService.Data;

public class AbpDownloadServiceTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<AbpDownloadServiceTenantDatabaseMigrationHandler> _logger;

    public AbpDownloadServiceTenantDatabaseMigrationHandler(
        IDbContextProvider<AuthServerHostMigrationsDbContext> dbContextProvider,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<AbpDownloadServiceTenantDatabaseMigrationHandler> logger)
    {
